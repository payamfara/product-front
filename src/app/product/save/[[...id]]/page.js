...
const CreateProductPage = () => {
    ...
    const handleSubmit = (e) => {
        ...
        linkedProducts.non_variant_product_attrs.filter((nv) => nv.attr_value !== null)
        linkedProducts.variant_product_attrs.filter((v) => v.attr_value !== null)
        console.log("linkedProducts", linkedProducts);
        linkedProducts.forEach(saveProduct);
    }
};
