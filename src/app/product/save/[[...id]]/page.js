        ...
        const handleSubmit = (e) => {
            ...
            const modifiedLinkedProducts = linkedProducts.map((linkedProduct) => ({
                ...
                non_variant_product_attrs: linkedProduct.non_variant_product_attrs
                    ...
                    : pageData.non_variant_product_attrs.map(({id, ...nv}) => nv)
            }))
            const NonEmptyLinkedProducts = modifiedLinkedProducts.map((linkedProduct) => ({
                ...linkedProduct,
                non_variant_product_attrs: linkedProduct.non_variant_product_attrs?.filter((nv) => nv.attr_value !== null),
                variant_product_attrs: linkedProduct.variant_product_attrs?.filter((v) => v.attr_value !== null),
            }))

            NonEmptyLinkedProducts.forEach(saveProduct);
        }
