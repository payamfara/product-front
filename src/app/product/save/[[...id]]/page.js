...
const CreateProductPage = () => {
  ...
  const updateFiles = (newFiles) =>
    setPageData((pageData) => ({ ...pageData, images: newFiles }));
                            ...
                            <div className="card-body d-flex flex-column gap-3">
                              ...
                              <DynamicAttributeField
                                ...
                                data={{
                                  ...
                                  attr_type:
                                    pageData.meta_datas.part_number_is_manual,
                                  attr_value: pageData.variant_products.find(
                                    (vp) => vp.id === pageData.id
                                  )?.part_number_is_manual,
                                }}
                              />
                              {/* Part number en */}
                              <div>
                                <DynamicAttributeField
                                  onChange={(value) =>
                                    handleChange("part_number_en", value)
                                  }
                                  className="p-2"
                                  data={{
                              ...
                              <div>
                                <DynamicAttributeField
                                  onChange={(value) =>
                                    handleChange("part_number_fa", value)
                                  }
                                  className="p-2"
                                  data={{
                              ...
                              <div>
                                <DynamicAttributeField
                                  onChange={(value) =>
                                    handleChange("part_number_bz", value)
                                  }
                                  className="p-2"
                                  data={{
