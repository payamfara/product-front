        ...
        <Fragment>
            <div className="col-7 offset-1">
                <div className="row row-cols-3">
                    ...
                    <div className="p-2"><DynamicAttributeField {...getProps('priority')} /></div>
                </div>
                <div className="row row-cols-3">
                ...
                <div className="row">
                    ...
                    <div className="p-2 col-3"><DynamicAttributeField {...getProps('weight')} /></div>
                </div>
                <div className="row row-cols-3">
                    <div className="p-2"><DynamicAttributeField {...getProps('prefix_en')} /></div>
                    <div className="p-2"><DynamicAttributeField {...getProps('prefix_fa')} /></div>
                    <div className="p-2"><DynamicAttributeField {...getProps('prefix_bz')} /></div>
                </div>
                <div className="row row-cols-3">
                    <div className="p-2"><DynamicAttributeField {...getProps('postfix_en')} /></div>
                    <div className="p-2"><DynamicAttributeField {...getProps('postfix_fa')} /></div>
                    <div className="p-2"><DynamicAttributeField {...getProps('postfix_bz')} /></div>
                </div>
            </div>
            <div className="col-4 row row-cols-2">
                {Object.keys(booleanDataMap).map((name, index) =>
                    <div key={`${rowIndex}-${index}`} className="p-2"><DynamicAttributeField {...getProps(name)} />
                    </div>
                )}
            </div>
        </Fragment>
